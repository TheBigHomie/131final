...
def popular_list():
    ...
    if count > mount and count > fount and fount > mount:
    #x>z>y
        lst4.append(x)
        lst4.append(z)
        lst4.append(y)
        print("The most popular books in order are:",lst4)
    if mount > count and mount > fount and count > fount:
    #y>x>z
        lst4.append(y)
        lst4.append(x)
        lst4.append(z)
        print("The most popular books in order are:",lst4)
    if mount > fount and mount > count and fount > count:
    #y>z>x
        lst4.append(y)
        lst4.append(z)
        lst4.append(x)
        print("The most popular books in order are:",lst4)
    if fount > count and fount > mount and count > mount:
    #z>x>y
        lst4.append(z)
        lst4.append(x)
        lst4.append(y)
        print("The most popular books in order are:",lst4)
    if fount > mount and fount > count and mount > count:
    #z>y>x
        lst4.append(z)
        lst4.append(y)
        lst4.append(x)
